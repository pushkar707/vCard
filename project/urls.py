...
from core.views import login,register,register_post,login_post,dashboard,createCard,show_card,logout,generate_vcard,show_image,test,edit_card,delete_card,show_qr
